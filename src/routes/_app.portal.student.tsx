      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <div className="overflow-x-auto pb-1">
          <TabsList className="inline-flex w-auto min-w-full sm:min-w-0 h-auto flex-nowrap gap-0.5 p-1">
            ...
            <TabsTrigger value="today" className="whitespace-nowrap text-xs sm:text-sm">My Day</TabsTrigger>
            ...
            <TabsTrigger value="discipline" className="whitespace-nowrap text-xs sm:text-sm">Discipline</TabsTrigger>
