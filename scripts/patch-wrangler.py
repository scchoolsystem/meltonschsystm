...
# Route everything except /assets/* and /images/* through the Worker first,
# so applySecurityHeaders() in server.ts runs on documents/navigations.
...
w.setdefault("assets", {})["run_worker_first"] = ["/*", "!/assets/*", "!/images/*", "!/legal.html"]
